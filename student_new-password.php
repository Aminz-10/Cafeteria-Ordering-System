...
<body>
	...
	<div class="all-page-title page-breadcrumb">
	  <div class="container text-center"><div class="row"><div class="col-lg-12">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						...
						<div class="container">
                        <br>
                          <form name="form1" action="student_new-password.php" method="POST" autocomplete="">
                            <div align="left">New Password :</div>
                              <div class="form-group">
                            <input type="password" class="form-control" name="s_pass" placeholder="Create new password" id="s_pass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                            </div>
                            <div class="form-group">
                            <input type="password" class="form-control" name="c_pass" placeholder="Confirm your password" id="c_pass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                            </div>
                            <button type="submit" name="change-password" class="btn btn-default">CHANGE</button>
                            &nbsp;&nbsp;
