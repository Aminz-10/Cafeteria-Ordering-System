		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container">
				<a class="navbar-brand" href="index.php">
					<img src="images/logo.png" width="20%" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cafeteria Ordering System				</a>
		...
		<ul class="slides-container">
			<li class="text-center">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Cafeteria PUO</strong></h1>
							<p class="m-b-40">I have seen some people die of starvation, keep eating. </p>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12">
					<img src="images/cafe.jpg" alt="" class="img-fluid">
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Kamsis Cafeteria</span></h1>
						<h4>Politeknik Ungku Omar</h4>
						<p>Terdapat banyak menu dari 3 gerai yang dapat anda pilih. Silakan order yaaa. </p>
						<a class="btn btn-lg btn-circle btn-outline-new-white" href="menu_1.php">MENU</a>
					</div>
				</div>
			</div>
		</div>
