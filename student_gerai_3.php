...
<?php
    mysql_select_db($database_cafeteria_system, $cafeteria_system);
    $query_Menu = "SELECT menu_id, menu_photo, menu_name, menu_price, menu_status FROM cafeteria WHERE categoryid = 3 ORDER BY menu_id ASC";
				...
				<div class="col-lg-12">
					<div class="special-menu text-center">
						<div class="button-group filter-button-group">
							<button onClick="location.href='student_gerai_1.php'"><?php echo $row_Gerai_1['gerai']; ?></button>
