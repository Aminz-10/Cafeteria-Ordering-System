...
<div class="container">
				...
				<div class="col-lg-12">
					<div class="special-menu text-center">
						<div class="button-group filter-button-group">
							<button onclick="location.href='s_menu_pak_abu.php'">Gerai Pak Abu<ri/button>
							<button class="active">Gerai Dollah</button>
			...
			<br>
            <div align="center">
              <table class="table-striped" width="50%" border="0" cellpadding="5">
                <tr>
