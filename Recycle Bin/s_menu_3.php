...
<div class="container">
				...
				<div class="col-lg-12">
					<div class="special-menu text-center">
						<div class="button-group filter-button-group">
							<button  onclick="location.href='s_menu_pak_abu.php'">Gerai Pak Abu</button>
							<button  onclick="location.href='s_menu_dollah.php'">Gerai Dollah</button>
						  	<button class="active">Gerai Che Jah</button>
						</div>
					</div>
				</div>
			</div>
			...
			<br>
            <div align="center">
              <table class="table-striped" width="50%" border="0" align="center" cellpadding="5">
                <tr>
