...
<?php
    mysql_select_db($database_cafeteria_system, $cafeteria_system);
    $query_Menu = "SELECT menu_id, menu_photo, menu_name, menu_price, menu_status FROM cafeteria";
	...
	<div class="about-section-box">
        <div class="container">
            <form action="<?php echo $editFormAction; ?>" name="form1" method="POST" onSubmit="return ValidationEvent()">
                ...
                <table class="table-striped w-100" border="0" cellpadding="5">
                    ...
                    ?>
                      <tr>
                        ...
                        ?>
                            <td><div align="center"><input type="checkbox" name="menu_id[<?php echo $ind;?>]" value="<?php echo $row_Menu['menu_id']; ?>"></div></td>
                            ...
                            <td><div align="center"><input class="form-control" type="number" name="quantity[]" value="0" min="0" max="10"></div></td>
                        <?php
                                $ind++;
                            } else {
                        ?>
                ...
                <div align="left"><strong><?php echo $_SESSION['MM_Username'];?></strong></div>
                </div>
