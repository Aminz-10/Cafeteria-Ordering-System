...
if (isset($_POST['matric'])) {
  $loginUsername=$_POST['matric'];
  $password=$_POST['pass'];
  $MM_fldUserAuthorization = "";
  $MM_redirectLoginSuccess = "student_gerai_1.php";
  $MM_redirectLoginFailed = "student_login1.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_cafeteria_system, $cafeteria_system);
  
  $LoginRS__query=sprintf("SELECT s_matric, s_pass FROM customer WHERE s_matric=%s AND s_pass=%s",
    GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
   
  $LoginRS = mysql_query($LoginRS__query, $cafeteria_system) or die(mysql_error());
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Student Login</h2>
						<p>Enter your Matric Number and Password</p>
						<div class="container">
                        <br>
                          <form name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
                            ...
                            <div class="form-group">
                              <input type="password" class="form-control" id="pass" placeholder="@Student123" name="pass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                            </div>
                             <p class="style5">Invalid Matric Number or password. Please try again.</p>
                             <br>
                             <div><a href="student_forgot_login.php" class="style6">Forgot password?</a></div>
                            <br>
