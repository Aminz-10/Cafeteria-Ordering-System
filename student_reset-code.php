			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						...
						<div class="container">
                        <br>
                          <form name="form1" action="student_reset-code.php" method="POST" autocomplete="">
                            <div align="left">Code Verification :</div>
                            <?php 
                    ...
                    ?>
                            <div class="form-group">
                              <input class="form-control" type="number" name="otp" placeholder="Enter code" pattern="{6}" required>
                            </div>
                            <br>
                            <button type="submit" name="check-reset-otp" class="btn btn-default">Submit</button>
                            &nbsp;&nbsp;
