...
if ((isset($_GET['menu_id'])) && ($_GET['menu_id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM cafeteria WHERE menu_id=%s",
                       GetSQLValueString($_GET['menu_id'], "text"));
  ...
  $deleteGoTo = "admin_menu.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $deleteGoTo .= (strpos($deleteGoTo, '?')) ? "&" : "?";
    $deleteGoTo .= $_SERVER['QUERY_STRING'];
  }
  echo "<script>
				alert('Menu has been delete');
				window.location = '$deleteGoTo';
			  </script>";
}
?><!DOCTYPE html>
<html lang="en"><!-- Basic -->
...
<body>
	...
	<div class="about-section-box">
		<div class="container">
		  <div align="center"><div class="col-lg-12">
