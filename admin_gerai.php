...
mysql_select_db($database_cafeteria_system, $cafeteria_system);
$query_Gerai = "SELECT * FROM category WHERE categoryid = '$category_id' ORDER BY categoryid ASC";
...
<body>
	...
	<div class="about-section-box">
		<div class="container">
          <table class="table-striped" width="40%" border="0" align="center" cellpadding="5">
            <tr>
            ...
            <?php do { ?>
              <tr>
                <td><div align="center"><?php echo $row_Gerai['gerai']; ?></div></td>
                <td><div align="center"><strong><a href="admin_gerai_update.php?categoryid=<?php echo $row_Gerai['categoryid']; ?>">UPDATE</a></strong></a></div></td>
                <!--<td><div align="center"><a href="admin_gerai_delete.php?categoryid=<?php echo $row_Gerai['categoryid']; ?>"><strong>DELETE</strong></a></div></td>-->
            </tr>
              <?php } while ($row_Gerai = mysql_fetch_assoc($Gerai)); ?>
          </table>
		</div>
	</div>
	<!-- End About -->
