...
$query_Menu = "SELECT menu_id, menu_photo, menu_name, menu_price FROM cafeteria WHERE categoryid = 3 ORDER BY menu_id ASC";
...
<div class="container">
				...
				<div class="col-lg-12">
					<div class="special-menu text-center">
						<div class="button-group filter-button-group">
							...
							<button  onclick="location.href='menu_2.php'"><?php echo $row_Gerai_2['gerai']; ?></button>
						  	<button class="active"><?php echo $row_Gerai_3['gerai']; ?></button>
						</div>
					</div>
				</div>
			</div>
			...
			<br>
            <div align="center">
              <table class="table-striped" width="60%" border="0" align="center" cellpadding="10">
                <tr>
