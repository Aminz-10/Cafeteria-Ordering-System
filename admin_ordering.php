...
if(isset($_POST['save'])){
    ...
    for ($i=0;$i<count($checkbox);$i++) {
        $del_id = $checkbox[$i]; 
        mysqli_query($con,"DELETE FROM ordering WHERE order_no='".$del_id."'");
...
<?php 
	...
	$query_ordering = "SELECT * 
			...
			RIGHT JOIN customer ON customer.s_matric = ordering.s_matric
          ...
          <table width="100%" border="0" align="center" cellpadding="5" class="table-striped">
            ...
            <?php do { ?>
              <tr>
                ...
                <td><div align="center"><?php echo $row_ordering['menu_name']; ?></div></td>
                <td><div align="center"><?php echo $row_ordering['quantity']; ?></div></td>
                <td><div align="center"><?php echo $row_ordering['date']; ?></div></td>
                <td><div align="center"><?php echo $row_ordering['time']; ?></div></td>
                <td><div align="center"><?php echo $row_ordering['s_phone']; ?></div></td>
                <td><div align="center"><?php echo $row_ordering['s_bilik']; ?></div></td>
                <td><div align="center"><img src="<?php echo $row_ordering['order_status']; ?>" height="40px" width="80px"></div></td>
                <td><div align="center"><?php echo $row_ordering['order_note']; ?></div></td>
                <td><div align="center"><strong><a href="admin_update_ordering.php?order_no=<?php echo $row_ordering['order_no']; ?>">UPDATE</a></strong></div></td>
